...
export const FINDINGS: Finding[] = [
  ...
  },
  {
    ...
    status: "parcial",
    fix: "Estrutura pronta para caso de aluno: progressão de rank antes/depois, métricas (K/D, dano, tempo até o salto), linha do tempo de como foi na prática, e um carrossel de casos com espaço pra foto, depoimento gravado ou highlights de gameplay.",
