export const META = {
  ...
  new: "ambiente de demonstração Vetrium",
};
...
export const NAV_SECTIONS: { id: SectionId; label: string }[] = [
  { id: "substrato", label: "O que já funcionava" },
  { id: "auditoria", label: "Auditoria visual" },
...
export const FINDINGS: Finding[] = [
  ...
  },
  {
    ...
    status: "parcial",
    fix: "Paleta mantida por equity de marca (é o que já reconhece nos 158 mil do YouTube), mas reorganizada com grid consistente, cartões e hierarquia tipográfica própria.",
  ...
  },
  {
    ...
    impact: "A estrutura já entrega o que mais converte nesse nicho — rank não mente. Os números exibidos hoje são um exemplo de formato, não dados reais: falta o cliente enviar 2 ou 3 casos de aluno pra trocar.",
  },
  {
    n: "08",
    category: "estrategia",
    title: "Selo “Mais escolhido” no plano errado",
    before: "O selo aparece no Veterano, o mais caro. Mas ~80% dos alunos assina o Recruta, e o próprio cliente aponta o Soldado como o de melhor custo-benefício.",
    status: "resolvido",
    ...
    impact: "O selo para de empurrar pro plano errado e passa a reforçar a decisão que o próprio Frog recomendaria.",
  },
  {
    n: "09",
    category: "estrategia",
    title: "Funil não resolve o descompasso aula 1:1 vs. curso",
    before: "A procura de quem chega é por aula individual, que depende da agenda do Frog. O site não explicava por que o esquadrão resolve o mesmo problema sem esse limite.",
    status: "resolvido",
...
export const COMPARISONS: Comparison[] = [
  {
    ...
    after: { img: "/diagnostico-frog/hero-depois.jpg", label: "Demonstração Vetrium" },
  ...
  },
  {
    ...
    after: { img: "/diagnostico-frog/resultados-depois.jpg", label: "Demonstração Vetrium" },
    findings: ["07"],
  ...
  },
  {
    ...
    after: { img: "/diagnostico-frog/precos-depois.jpg", label: "Demonstração Vetrium" },
    findings: ["08"],
...
export const NEXT_STEPS = [
  "Levantar 2 ou 3 casos reais de aluno com rank antes/depois, pra trocar o exemplo de formato da prova social por dados reais.",
  "Decidir, com o cliente, se vale introduzir um segundo elemento visual próprio além do verde/roxo — por equity de marca, recomendamos manter a paleta.",
  "Definir onde o lead capturado cai (e-mail, CRM ou planilha) pra ligar o formulário a um destino real.",
  "Confirmar com o cliente as respostas do FAQ sobre cancelamento e prazo de acesso, pra bater com o que está configurado na Kiwify.",
];
