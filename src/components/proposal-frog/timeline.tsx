...
import { RULES, TIMELINE } from "@/lib/proposal-frog/content";
  ...
  return (
    <Section id="prazos">
      <SectionHead
        ...
        lead="Quatro etapas, e não as seis de um projeto do zero: a página já existe. O que resta é ajustar ao seu gosto, ligar o que falta e publicar."
        maxWidth="56ch"
      />
          ...
          <Reveal key={step.n} delay={i * 0.06} className="relative grid grid-cols-[34px_1fr] gap-4 pb-5 last:pb-0">
            ...
            <div>
              ...
              <p className="text-[14px] text-ink-dim">
                {step.n === 4
                  ? `Saldo de 60%${plan.id === "funcional" ? ", publicação" : ""} e transferência ${
