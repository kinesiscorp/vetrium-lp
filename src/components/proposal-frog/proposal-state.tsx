...
import { PLANS, type PaymentMode, type PlanId } from "@/lib/proposal-frog/content";
...
/** Estado compartilhado entre a seção de investimento, pagamento e o
 *  fechamento: qual pacote e qual forma de pagamento a pessoa está
 *  considerando. Default no pacote recomendado, parcelado. */
