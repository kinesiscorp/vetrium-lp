...
import { CASES } from "@/lib/proposal-frog/content";
    ...
    <Section id="quem-faz">
      ...
      <Reveal delay={0.26}>
        <p className="mt-5 text-[13.5px] text-muted">
          Antes de qualquer conversa de valor, já construímos a página inteira e deixamos no ar para
          você navegar. Isso responde melhor do que qualquer portfólio.
        </p>
      </Reveal>
    </Section>
  );
