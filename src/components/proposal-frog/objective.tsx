import { TARGETS } from "@/lib/proposal-frog/content";
  ...
  return (
    <Section id="objetivo">
      ...
      <Reveal delay={0.16} className="mt-6 border-l-2 border-accent-solid bg-[rgba(124,108,255,0.06)] py-4 px-5 text-[14.5px] text-ink-dim">
        Os dois alvos são mensuráveis. Depois da entrega dá pra comparar quantos contatos entraram e
        como a distribuição entre os planos mudou, <b className="font-semibold text-ink">e é assim que a gente sabe se o trabalho funcionou</b>.
      </Reveal>
    </Section>
  );
}
