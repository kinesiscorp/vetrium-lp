import { DIAGNOSTIC_URL, FINDINGS } from "@/lib/proposal-jjl/content";
  ...
  return (
    <Section id="diagnostico">
      <SectionHead
        ...
        lead="Analisamos jjlservicos.com.br de fora pra dentro antes de desenhar qualquer coisa. Quatro pontos concentram boa parte da perda."
        maxWidth="54ch"
      />
      ...
      <p className="mt-5 text-[13.5px] text-muted">
        Diagnóstico completo com dez achados, print de cada um e as perguntas que ainda
        estão em aberto,{" "}
        <a
          href={DIAGNOSTIC_URL}
          target="_blank"
