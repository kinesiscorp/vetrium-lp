...
import { META, WHATSAPP_NUMBER, type PaymentMode } from "@/lib/proposal-jjl/content";
...
function buildAcceptMessage(planName: string, paymentMode: PaymentMode, price: number) {
  const lines = [
    `Olá! Sou responsável pela ${META.client}.`,
...
const ADJUST_MESSAGE =
  "Olá! Vi a proposta de redesign do site da JJL Serviços e quero ajustar escopo ou prazo antes de fechar.";
  ...
  return (
    <Section id="fechamento" className="relative overflow-hidden">
      ...
      <div className="relative">
        <SectionHead num="10" title="Próximo passo" />
        ...
        <Reveal>
          <p className="max-w-[50ch] text-[clamp(16px,1.9vw,18.5px)] leading-relaxed text-ink-dim">
            ...
            entrada de 50%, e a agenda fica reservada no seu nome.
          </p>
        </Reveal>
