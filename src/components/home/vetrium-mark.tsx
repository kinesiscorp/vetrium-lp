...
/**
 * Glifos de cristal para uso inline dentro de títulos — três cortes do
 * mesmo mineral, em contorno, para o bloco do manifesto.
 */
const GLYPHS = {
  shard: {
    body: "M50 8 L82 40 L50 92 L18 40 Z",
    cuts: ["M18 40 L50 52 L82 40", "M50 8 L50 92"],
  },
  prism: {
    body: "M22 18 L78 26 L64 84 L30 74 Z",
    cuts: ["M22 18 L64 84", "M78 26 L30 74"],
  },
  facet: {
    body: "M50 10 L88 32 L74 78 L26 78 L12 32 Z",
    cuts: ["M12 32 L50 46 L88 32", "M50 46 L50 78", "M26 78 L50 46 L74 78"],
  },
} as const;
...
export function CrystalGlyph({
  ...
  const { body, cuts } = GLYPHS[shape];
  return (
    <svg viewBox="0 0 100 100" fill="none" className={className} aria-hidden>
      <path d={body} fill="var(--halo)" />
      <g
        stroke="currentColor"
        strokeWidth="4"
        strokeLinejoin="round"
      ...
      >
        <path d={body} />
        {cuts.map((d) => (
          <path key={d} d={d} strokeWidth="2.4" opacity="0.55" />
        ))}
      </g>
    </svg>
  );
